...
class TestRSSISensor:
    ...
    def test_with_device_info(self) -> None:
        ...
        sensor = TuyaBLEMeshRSSISensor(coord, "entry1", device_info)
...
class TestFirmwareSensor:
    ...
    def test_with_device_info(self) -> None:
        ...
        sensor = TuyaBLEMeshFirmwareSensor(coord, "entry1", device_info)
        assert sensor._attr_device_info == device_info
...
class TestPowerSensor:
    ...
    def test_with_device_info(self) -> None:
        ...
        sensor = TuyaBLEMeshPowerSensor(coord, "entry1", device_info)
        assert sensor._attr_device_info == device_info
...
class TestEnergySensor:
    ...
    def test_with_device_info(self) -> None:
        ...
        sensor = TuyaBLEMeshEnergySensor(coord, "entry1", device_info)
        assert sensor._attr_device_info == device_info
